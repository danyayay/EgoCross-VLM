...
logdirs=(logs/qwen_new_qn3_cot4_eval)
        ...
        for model_name in "${model_name[@]}"; do
            for temperature in "${temperatures[@]}"; do
                for logdir in "${logdirs[@]}"; do
                    anno_file=features/groundvqa_qn3/annotations.VRbinary_${setup}_test_close.json
                    python -m training.eval_qwen \
                        --model_name $model_name \
                        --temperature $temperature \
                        --sample_fps $sample_fps \
            ...
            for temperature in "${temperatures[@]}"; do
                for logdir in "${logdirs[@]}"; do
                    ...
                    python -m training.eval_qwen \
                        ...
                        --logdir $logdir \
                        --outdir $logdir \
                        --video_root data/videodata_256/clips_dot
