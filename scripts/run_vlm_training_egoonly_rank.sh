...
#   SEEDS="42 43 44" LORA_RANKS="1 2 4 8" LORA_ALPHAS="4 8 16" \
#     bash scripts/run_vlm_training_egoonly_rank.sh
...
LORA_RANKS="${LORA_RANKS:-2 4 8}" # 1 2 4 8
LORA_ALPHAS="${LORA_ALPHAS:-4 8 16}" # 2 4 8 16
